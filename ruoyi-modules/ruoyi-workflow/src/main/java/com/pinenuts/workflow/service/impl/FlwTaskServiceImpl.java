package com.pinenuts.workflow.service.impl;
...
import com.pinenuts.common.core.domain.dto.UserDTO;
import com.pinenuts.common.core.enums.BusinessStatusEnum;
import com.pinenuts.common.core.exception.ServiceException;
import com.pinenuts.common.core.service.UserService;
import com.pinenuts.common.core.utils.StreamUtils;
import com.pinenuts.common.core.utils.StringUtils;
import com.pinenuts.common.core.utils.ValidatorUtils;
import com.pinenuts.common.core.validate.AddGroup;
import com.pinenuts.common.core.validate.EditGroup;
import com.pinenuts.common.json.utils.JsonUtils;
import com.pinenuts.common.mybatis.core.page.PageQuery;
import com.pinenuts.common.mybatis.core.page.TableDataInfo;
import com.pinenuts.common.mybatis.utils.IdGeneratorUtil;
import com.pinenuts.common.satoken.utils.LoginHelper;
import com.pinenuts.warm.flow.core.FlowEngine;
import com.pinenuts.warm.flow.core.dto.FlowParams;
import com.pinenuts.warm.flow.core.entity.*;
import com.pinenuts.warm.flow.core.enums.CooperateType;
import com.pinenuts.warm.flow.core.enums.NodeType;
import com.pinenuts.warm.flow.core.enums.SkipType;
import com.pinenuts.warm.flow.core.enums.UserType;
import com.pinenuts.warm.flow.core.service.*;
import com.pinenuts.warm.flow.core.utils.ExpressionUtil;
import com.pinenuts.warm.flow.core.utils.MapUtil;
import com.pinenuts.warm.flow.orm.entity.*;
import com.pinenuts.warm.flow.orm.mapper.FlowHisTaskMapper;
import com.pinenuts.warm.flow.orm.mapper.FlowInstanceMapper;
import com.pinenuts.warm.flow.orm.mapper.FlowNodeMapper;
import com.pinenuts.warm.flow.orm.mapper.FlowTaskMapper;
import com.pinenuts.workflow.common.ConditionalOnEnable;
import com.pinenuts.workflow.common.enums.TaskAssigneeType;
import com.pinenuts.workflow.common.enums.TaskOperationEnum;
import com.pinenuts.workflow.common.enums.TaskStatusEnum;
import com.pinenuts.workflow.domain.FlowInstanceBizExt;
import com.pinenuts.workflow.domain.bo.*;
import com.pinenuts.workflow.domain.vo.FlowCopyVo;
import com.pinenuts.workflow.domain.vo.FlowHisTaskVo;
import com.pinenuts.workflow.domain.vo.FlowTaskVo;
import com.pinenuts.workflow.domain.vo.NodeExtVo;
import com.pinenuts.workflow.mapper.FlwCategoryMapper;
import com.pinenuts.workflow.mapper.FlwInstanceBizExtMapper;
import com.pinenuts.workflow.mapper.FlwTaskMapper;
import com.pinenuts.workflow.service.IFlwCommonService;
import com.pinenuts.workflow.service.IFlwNodeExtService;
import com.pinenuts.workflow.service.IFlwTaskAssigneeService;
import com.pinenuts.workflow.service.IFlwTaskService;
import org.springframework.stereotype.Service;
import org.springframework.transaction.annotation.Transactional;

import java.util.*;

import static com.pinenuts.workflow.common.constant.FlowConstant.*;
